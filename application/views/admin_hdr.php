...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="<?php echo base_url();?>index.php/Admin/index" class="logo"> <span class="lite">Admin</span></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                ...
                                <a href="<?php echo base_url()?>index.php/Loginadmin/do_logout"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
                        </ul>
                    </li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
                   ...
                   <li>
                      <a class="" href="<?php echo base_url();?>index.php/Admin/bukutamu">
                 ...
                 <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url();?>index.php/Admin/tambahmapel">Tambah Buku Pelajaran</a></li> 
                          <li><a class="" href="<?php echo base_url();?>index.php/Admin/daftarmapel">Daftar Buku Pelajaran</a></li>                          
                      </ul>
                  </li>     
                 <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url();?>index.php/Admin/tambah">Tambah Guru</a></li> 
                          <li><a class="" href="<?php echo base_url();?>index.php/Admin/daftar">Daftar Guru</a></li>                          
                      </ul>
                  </li>       
